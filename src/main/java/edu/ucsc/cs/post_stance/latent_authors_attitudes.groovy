...
Evaluator evaluator = new Evaluator(testDB, isProPost, "psl_ideology_seeded", fold);
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_authors_attitude", fold);
evaluator.outputToFile();
