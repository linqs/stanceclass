...
model.add rule : (agrees(P1, P2, A1, A2) & (A1-A2) & participates(A2, T) & isProAuth(A1, T)) >> isProAuth(A2, T), weight : initialWeight
model.add rule : (agrees(P1, P2, A1, A2) & (A1-A2) & participates(A1, T) & participates(A2, T) & ~(isProAuth(A1, T))) >> ~(isProAuth(A2, T)), weight :initialWeight

model.add rule : (sarcastic(P1, P2, A1, A2) & (A1-A2) & participates(A2, T) & isProAuth(A1, T)) >> ~isProAuth(A2, T), weight : initialWeight
model.add rule : (sarcastic(P1, P2, A1, A2) & (A1-A2) & participates(A1, T) & participates(A2, T) & ~(isProAuth(A1, T))) >> (isProAuth(A2, T)), weight :initialWeight

model.add rule : (nasty(P1, P2, A1, A2) & (A1-A2) & participates(A2, T) & isProAuth(A1, T)) >> ~isProAuth(A2, T), weight : initialWeight
model.add rule : (nasty(P1, P2, A1, A2) & (A1-A2) & participates(A1, T) & participates(A2, T) & ~(isProAuth(A1, T))) >> (isProAuth(A2, T)), weight :initialWeight

model.add rule : (attacks(P1, P2, A1, A2) & (A1-A2) & participates(A2, T) & isProAuth(A1, T)) >> ~isProAuth(A2, T), weight : initialWeight
model.add rule : (attacks(P1, P2, A1, A2) & (A1-A2) & participates(A1, T) & participates(A2, T) & ~(isProAuth(A1, T))) >> (isProAuth(A2, T)), weight :initialWeight
...
Evaluator evaluator = new Evaluator(testDB, isProPost, "psl_ideology_seeded_astance", fold);
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_authors_attitude_astance", fold);
evaluator.outputToFile();
