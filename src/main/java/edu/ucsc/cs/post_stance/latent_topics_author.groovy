...
model.add rule : (isProAuth(A, "abortion")) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProAuth(A, "abortion") & participates(A, "abortion")) >> hasIdeologyA(A) , weight : seededNegWeight
...
model.add rule : (hasIdeologyA(A) & participates(A, "abortion")) >> isProAuth(A, "abortion") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & participates(A, "abortion")) >> ~isProAuth(A, "abortion") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "abortion")) >> isProAuth(A, "abortion") , weight : initialWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "abortion")) >> ~isProAuth(A, "abortion") , weight : initialWeight

model.add rule : (isProAuth(A, "gaymarriage")) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProAuth(A, "gaymarriage") & participates(A, "gaymarriage")) >> hasIdeologyA(A) , weight : seededNegWeight
...
model.add rule : (hasIdeologyA(A) & participates(A, "gaymarriage")) >> isProAuth(A, "gaymarriage") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & participates(A, "gaymarriage")) >> ~isProAuth(A, "gaymarriage") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "gaymarriage")) >> isProAuth(A, "gaymarriage") , weight : initialWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "gaymarriage")) >> ~isProAuth(A, "gaymarriage") , weight : initialWeight

model.add rule : (isProAuth(A, "guncontrol")) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProAuth(A, "guncontrol") & participates(A, "guncontrol")) >> hasIdeologyA(A) , weight : seededNegWeight
...
model.add rule : (hasIdeologyA(A) & participates(A, "guncontrol")) >> isProAuth(A, "guncontrol") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & participates(A, "guncontrol")) >> ~isProAuth(A, "guncontrol") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "guncontrol")) >> isProAuth(A, "guncontrol") , weight : initialWeight
model.add rule : (~hasIdeologyA(A) & participates(A, "guncontrol")) >> ~isProAuth(A, "guncontrol") , weight : initialWeight

model.add rule : (isProAuth(A, "evolution")) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProAuth(A, "evolution") & participates(A, "evolution")) >> hasIdeologyA(A) , weight : seededNegWeight
...
model.add rule : (hasIdeologyA(A) & participates(A, "evolution")) >> isProAuth(A, "evolution") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & participates(A, "evolution")) >> ~isProAuth(A, "evolution") , weight : seededNegWeight
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_topics_authors", fold);
evaluator.outputToFile();
