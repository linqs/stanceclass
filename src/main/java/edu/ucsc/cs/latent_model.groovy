...
model.add predicate: "hasIdeologyB" , types:[ArgumentType.UniqueID]
...
model.add rule : (agreesAuth(A1, A2, T) & (A1^A2) & participates(A1, T) & ~(isProAuth(A1, T))) >> ~(isProAuth(A2, T)), weight :initialWeight

model.add rule : (disagreesAuth(A1, A2, T) & (A1^A2) & participates(A2, T)& isProAuth(A1, T)) >> ~(isProAuth(A2, T)), weight :initialWeight
model.add rule : (disagreesAuth(A1, A2, T) & (A1^A2) & topic(T) & participates(A1, T) & ~(isProAuth(A1, T))) >> isProAuth(A2, T), weight : initialWeight

model.add rule : (sarcastic(A1, A2, P, T) & (A1^A2) & participates(A2, T) & isProAuth(A1, T)) >> ~(isProAuth(A2, T)), weight :initialWeight
model.add rule : (sarcastic(A1, A2, P, T) & (A1^A2) & topic(T) & participates(A1, T) & ~(isProAuth(A1, T))) >> isProAuth(A2, T), weight : initialWeight

model.add rule : (nasty(A1, A2, T) & (A1^A2) & participates(A2, T) & isProAuth(A1, T)) >> ~(isProAuth(A2, T)), weight :initialWeight
model.add rule : (nasty(A1, A2, T) & (A1^A2) & topic(T) & participates(A1, T) & ~(isProAuth(A1, T))) >> isProAuth(A2, T), weight : initialWeight

model.add rule : (attacks(A1, A2, T) & (A1^A2) & participates(A2, T) & isProAuth(A1, T)) >> ~(isProAuth(A2, T)), weight :initialWeight
model.add rule : (attacks(A1, A2, T) & (A1^A2) & topic(T) & participates(A1, T) & ~(isProAuth(A1, T))) >> isProAuth(A2, T), weight : initialWeight
*/
...
model.add rule : (hasIdeologyB(A1) & hasIdeologyB(A2) & (A1 - A2) & isProAuth(A1, T) & participates(A2, T)) >> isProAuth(A2, T), weight : initialWeight
model.add rule : (hasIdeologyB(A1) & hasIdeologyB(A2) & (A1 - A2) & ~isProAuth(A1, T) & participates(A1, T) & participates(A2, T)) >> ~isProAuth(A2, T), weight : initialWeight

model.add rule : (isProAuth(A1, T) & isProAuth(A2, T)  & (A1 - A2) & hasIdeologyB(A1)) >> hasIdeologyB(A2), weight : initialWeight
model.add rule : (~isProAuth(A1, T) & ~isProAuth(A2, T) & (A1 - A2) & participates(A1, T) & participates(A2, T) & hasIdeologyB(A1)) >> hasIdeologyB(A2), weight : initialWeight

//model.add rule : (hasIdeologyA(A1)) >> ~hasIdeologyB(A1), constraint : true
//model.add rule : (~hasIdeologyB(A1) & participates(A1, T)) >> hasIdeologyA(A1), constraint : true
...
inserter = data.getInserter(hasIdeologyB, dummy_tr)
InserterUtils.loadDelimitedData(inserter, dir + "hasIdeologyB.csv", ",")
...
inserter = data.getInserter(hasIdeologyB, dummy_te)
InserterUtils.loadDelimitedData(inserter, testdir + "hasIdeologyB.csv", ",")
...
Database dummy_DB = data.getDatabase(dummy_tr, [hasIdeologyA, hasIdeologyB, supports, isProAuth, isProPost] as Set)
...
dbPop.populateFromDB(dummy_DB, hasIdeologyB);
...
Database dummy_test = data.getDatabase(dummy_te, [hasIdeologyA, hasIdeologyB, supports, isProAuth, isProPost] as Set)
...
test_populator.populateFromDB(dummy_test, hasIdeologyB);
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_dual", fold);
evaluator.outputToFile();

/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyB, "ideologyB_dual", fold);
evaluator.outputToFile();
...
class NotEquals implements ExternalFunction {
	...
	public double getValue(ReadOnlyDatabase db, GroundTerm... args) {
		return args[0].toString().equals(args[1].toString()) ? 0.0 : 1.0;
	}
