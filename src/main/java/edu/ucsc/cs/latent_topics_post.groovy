...
model.add rule : (isProPost(P, "abortion") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProPost(P, "abortion") & hasTopic(P, "abortion") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (isProPost(P, "abortion") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (~isProPost(P, "abortion") & hasTopic(P, "abortion") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "abortion")) >> isProPost(P, "abortion") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "abortion")) >> ~isProPost(P, "abortion") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "abortion")) >> isProPost(P, "abortion") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "abortion")) >> ~isProPost(P, "abortion") , weight : seededWeight


model.add rule : (isProPost(P, "gaymarriage") & writesPost(A, P)) >> hasIdeologyA(A) , weight : initialWeight
model.add rule : (~isProPost(P, "gaymarriage") & hasTopic(P, "gaymarriage") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (isProPost(P, "gaymarriage") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : initialWeight
model.add rule : (~isProPost(P, "gaymarriage") & hasTopic(P, "gaymarriage") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "gaymarriage")) >> isProPost(P, "gaymarriage") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "gaymarriage")) >> ~isProPost(P, "gaymarriage") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "gaymarriage")) >> isProPost(P, "gaymarriage") , weight : initialWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "gaymarriage")) >> ~isProPost(P, "gaymarriage") , weight : initialWeight


model.add rule : (isProPost(P, "guncontrol") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededWeight
model.add rule : (~isProPost(P, "guncontrol") & hasTopic(P, "guncontrol") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (isProPost(P, "guncontrol") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (~isProPost(P, "guncontrol") & hasTopic(P, "guncontrol") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "guncontrol")) >> isProPost(P, "guncontrol") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "guncontrol")) >> ~isProPost(P, "guncontrol") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "guncontrol")) >> isProPost(P, "guncontrol") , weight : seededNegWeight
model.add rule : (~hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "guncontrol")) >> ~isProPost(P, "guncontrol") , weight : seededWeight


model.add rule : (isProPost(P, "evolution") & writesPost(A, P)) >> hasIdeologyA(A) , weight : initialWeight
model.add rule : (~isProPost(P, "evolution") & hasTopic(P, "evolution") & writesPost(A, P)) >> hasIdeologyA(A) , weight : seededNegWeight
model.add rule : (isProPost(P, "evolution") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : initialWeight
model.add rule : (~isProPost(P, "evolution") & hasTopic(P, "evolution") & writesPost(A, P)) >> ~hasIdeologyA(A) , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "evolution")) >> isProPost(P, "evolution") , weight : seededWeight
model.add rule : (hasIdeologyA(A) & writesPost(A, P) & hasTopic(P, "evolution")) >> ~isProPost(P, "evolution") , weight : seededNegWeight
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_topics_post", fold);
evaluator.outputToFile();
