...
//model.add rule : (agreesAuth(A1, A2, T) & (A1-A2) & participates(A1, T) & participates(A2, T) & isProAuth(A2, T)) >> isProAuth(A1, T), weight : initialWeight
//model.add rule : (agreesAuth(A1, A2, T) & (A1-A2) & participates(A1, T) & participates(A2, T)& ~isProAuth(A2, T)) >> ~isProAuth(A1, T), weight : initialWeight
//model.add rule : (disagreesAuth(A1, A2, T) & (A1-A2) & participates(A1, T) & participates(A2, T) & isProAuth(A2, T)) >> ~(isProAuth(A1, T)), weight : initialWeight
//model.add rule : (disagreesAuth(A1, A2, T) & (A1-A2) & topic(T) & participates(A1, T) & participates(A1, T) & ~isProAuth(A2, T)) >> isProAuth(A1, T), weight : initialWeight
...
Database distributionDB = data.getDatabase(predict_tr, [agreesAuth, disagreesAuth, hasLabelPro, sarcastic, nasty, attacks, agrees, participates, topic] as Set, observed_tr);
...
Database testDB = data.getDatabase(predict_te, [agreesAuth, disagreesAuth, hasLabelPro, sarcastic, nasty, attacks, agrees, participates, topic] as Set, observed_te);
