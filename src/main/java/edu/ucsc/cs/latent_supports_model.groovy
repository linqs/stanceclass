...
model.add predicate: "valInt" , types:[ArgumentType.UniqueID, ArgumentType.UniqueID] 
...
model.add rule : (agrees(P1, P2, A1, A2) & (P1 - P2) & (A1 - A2) & participates(A1, T) & participates(A2, T)) >> supports(A1, A2), weight : initialWeight
model.add rule : (sarcastic(P1, P2, A1, A2) & (P1 - P2) & (A1 - A2) & participates(A1, T) & participates(A2, T)) >> ~supports(A1, A2) , weight : initialWeight
model.add rule : (nasty(P1, P2, A1, A2) & (P1 - P2) & (A1 - A2) & participates(A1, T) & participates(A2, T)) >> ~supports(A1, A2) , weight : initialWeight
model.add rule : (attacks(P1, P2, A1, A2) & (P1 - P2) & (A1 - A2) & participates(A1, T) & participates(A2, T)) >> ~supports(A1, A2) , weight : initialWeight
...
model.add rule : (~supports(A1, A2) & (A1 - A2) & valInt(A1, A2) & participates(A2, T) & participates(A1, T) & isProAuth(A1, T)) >> ~isProAuth(A2, T), weight : initialWeight
model.add rule : (~supports(A1, A2) & (A1 - A2) & valInt(A1, A2) & participates(A2, T) & participates(A1, T) & ~isProAuth(A1, T)) >> isProAuth(A2, T), weight : initialWeight
...
InserterUtils.loadDelimitedData(inserter, dir+"bin_supports.csv", ",");
...
InserterUtils.loadDelimitedData(inserter, testdir+"bin_supports.csv", ",");
