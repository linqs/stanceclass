...
//model.add rule: (hasIdeology(A, I) & participates(A, "abortion")) >> isProAuth(A,"abortion"), weight : initialWeight, squared:squared
//model.add rule: (hasIdeology(A, I) & participates(A, "evolution")) >> isProAuth(A, "evolution"), weight : initialWeight, squared:squared
//model.add rule: (hasIdeology(A, I) & participates(A, "gaymarriage")) >> isProAuth(A, "gaymarriage"), weight : initialWeight, squared:squared
//model.add rule: (hasIdeology(A, I) & participates(A, "guncontrol")) >> isProAuth(A, "guncontrol"), weight : initialWeight, squared:squared
...
//    model.add rule: (hasIdeology(A, I) & participates(A, "abortion")) >> isProAuth(A,"abortion"), weight : initialWeight
//    model.add rule: (hasIdeology(A, I) & participates(A, "evolution")) >> isProAuth(A, "evolution"), weight : initialWeight
//    model.add rule: (hasIdeology(A, I) & participates(A, "gaymarriage")) >> isProAuth(A, "gaymarriage"), weight : initialWeight
//    model.add rule: (hasIdeology(A, I) & participates(A, "guncontrol")) >> isProAuth(A, "guncontrol"), weight : initialWeight
...
model.add rule: (~isProAuth(A, "gaymarriage") & participates(A, "gaymarriage")) >> hasIdeology(A, lastIdeology), weight : 10
...
Evaluator evaluator = new Evaluator(testDB, isProAuth, "psl_authorstance_ideology", fold);
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeology, "ideology_authorstance_topics", fold);
evaluator.outputToFile();
