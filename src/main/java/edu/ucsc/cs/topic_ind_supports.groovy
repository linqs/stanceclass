...
model.add rule : (agreesAuth(A1, A2, T) & (A1 - A2)) >> supports(A1, A2) , weight : initialWeight
model.add rule : (disagreesAuth(A1, A2, T) & (A1 - A2)) >> against(A1, A2) , weight : initialWeight

/*
 * Rules relating sarcasm to against
 */
model.add rule : (sarcastic(A1, A2, P, T) & (A1 - A2)) >> against(A1, A2) , weight : initialWeight

/*
 * Rules relating nastiness to against
 */
model.add rule : (nasty(A1, A2, T) & (A1 - A2)) >> against(A1, A2) , weight : initialWeight
