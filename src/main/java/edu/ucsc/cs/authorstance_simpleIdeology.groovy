...
Evaluator evaluator = new Evaluator(testDB, isProAuth, "psl_authorstance_simpleIdeology", fold);
...
/*output prediction results */
evaluator = new Evaluator(testDB, hasIdeologyA, "ideologyA_authorstance_simpleIdeology", fold);
evaluator.outputToFile();
...
try {
    ...
    ResultWriter rs = new ResultWriter(score, fold, 'result_simpleIdeology.txt')
    rs.write()
}
